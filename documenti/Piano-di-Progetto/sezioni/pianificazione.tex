...
\begin{itemize}
    ...
    Il gruppo si concentra sulle attività di codifica, in particolar modo vengono sviluppate le seguenti funzionalità: \textit{caricamento dataset$^{G}$}, \textit{Parsing}, \textit{Rendering Scatter Plot$^{G}$} e \textit{Associazione degli assi alle dimensioni}.\\
