...
Per l'esplorazione dei dati si utilizzerà un approccio EDA (\textit{Exploratory Data Analysis}), il quale promuove una visualizzazione grafica del dato. \\ 
...
\item Possibilità di creare e salvare nuove \textbf{viste} personalizzate.
