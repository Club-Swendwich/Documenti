...
\begin{figure}[h!]
	...
	\caption{UC7 - Personalizzazione Force-directed graph}
\end{figure}
\begin{itemize}
    \item \textbf{Attore primario:} Utente.
	...
	\item \textbf{Scenario principale:}L'utente decide:
	\begin{itemize}
        \item Associazione delle dimensioni \hyperref[sec:UC7.3.1]{UC7.3.1}.
        \item Ordine degli assi \hyperref[sec:UC7.3.2]{UC7.3.2}.
        \item Personalizzazione dello stile \hyperref[sec:UC7.3.3]{UC7.3.3}.
    \end{itemize}
\end{itemize}
\paragraph{UC7.3.1 - Scelta tipo di algoritmo di integrazione}
\label{sec:UC7.3.1}
    \begin{itemize}
        \item \textbf{Attore primario:} Utente.
	    ...
	    \item \textbf{Scenario principale:} L'utente sceglie l'algoritmo di integrazione che desidera.
    \end{itemize}
\paragraph{UC7.3.2 - Scelta della funzione di forza}
\label{sec:UC7.3.2}
    \begin{itemize}
        \item \textbf{Attore primario:} Utente.
        \item \textbf{Precondizioni:} L'utente ha selezionato Force-directed graph. \hyperref[sec:UC2.3]{UC2.3}.
	    ...
	    \item \textbf{Estensioni:} Nel caso i parametri non rientrino nei limiti fissati:
              ...
              \end{itemize}
    \end{itemize}
\paragraph{UC7.3.3 - Personalizzazione dello stile}
\label{sec:UC7.3.3}
    \begin{itemize}
        \item \textbf{Attore primario:} Utente.
        \item \textbf{Precondizioni:} L'utente ha selezionato Force-directed graph \hyperref[sec:UC2.3]{UC2.3}.
...
\begin{figure}[h!]
	...
	\caption{UC7 - Personalizzazione Personalizzazione Sankey diagram}
\end{figure}
\begin{itemize}
    \item \textbf{Attore primario:} Utente.
	...
	\item \textbf{Scenario principale:}L'utente decide:
	\begin{itemize}
        \item Ordinamento dei dati \hyperref[sec:UC7.4.1]{UC7.4.1}.
        \item Personalizzazione dello stile \hyperref[sec:UC7.4.2]{UC7.4.2}.
    \end{itemize}
\end{itemize}
\paragraph{UC7.4.1 - Ordinamento dei dati}
\label{sec:UC7.4.1}
    \begin{itemize}
        \item \textbf{Attore primario:} Utente.
	    ...
	    \item \textbf{Estensioni:} Nel caso i parametri non rientrino nelle relazioni fissate:
              ...
              \end{itemize}
    \end{itemize}
\paragraph{UC7.4.2 - Personalizzazione dello stile}
\label{sec:UC7.4.2}
    \begin{itemize}
        \item \textbf{Attore primario:} Utente.
        \item \textbf{Precondizioni:} L'utente ha selezionato Sankey diagram \hyperref[sec:UC2.3]{UC2.3}.
