...
\begin{itemize}
    ...
    \item \textbf{Postcondizioni}: Viene eliminata la vista$^{G}$ selezionata.
    \item \textbf{Scenario principale}:
          \begin{enumerate}
...
\begin{itemize}
	\item \textbf{Attore primario:} Utente.
	\item \textbf{Precondizioni:} Il ${\mathrm{dataset^{G}}}$ è presente e caricato correttamente. L'utente ha cliccato il pulsante per l'eliminazione di una vita \hyperref[sec:UC3]{UC3}.
	\item \textbf{Postcondizioni:} Viene eliminala la vita, oppure l'operazione viene annullata.
	\item \textbf{Scenario principale:}
		\begin{enumerate}
...
\begin{itemize}
	...
	\begin{enumerate}
        ...
        \item \textit{Scaling$^{G}$} dei dati \hyperref[sec:UC5.2.3]{UC5.2.3}.
...
\label{sec:UC5.2.3}
    \begin{itemize}
	    ...
	    \item \textbf{Scenario principale:} 
	    \begin{enumerate}
	    		\item L'utente sceglie lo \textit{scaling$^{G}$} dei dati.
		\end{enumerate}
    \end{itemize}
...
\begin{itemize}
    \item \textbf{Attore primario:} Utente.
    \item \textbf{Precondizioni:} Il ${\mathrm{dataset^{G}}}$ è stato caricato correttamente. L'utente ha cliccato il pulsante ``Creazione nuova vista$^{G}$'' scegliendo quali celle/righe/colonne visualizzare (\hyperref[sec:UC11.1]{UC11.1}) e ha scelto il grafico Scatter Plot$^{G}$.
...
\begin{itemize}
    ...
    \begin{enumerate}
		...
		\item L'utente può decidere lo \textit{scaling$^{G}$} dei dati \hyperref[sec:UC11.3.3]{UC11.3.3}.
	\end{enumerate}
\end{itemize}
...
\begin{itemize}
    \item \textbf{Attore primario:} Utente.
    \item \textbf{Precondizioni:} Il ${\mathrm{dataset^{G}}}$ è stato caricato correttamente. L'utente ha cliccato il pulsante ``Creazione nuova vista$^{G}$'' scegliendo quali celle/righe/colonne visualizzare (\hyperref[sec:UC11.1]{UC11.1}) e ha scelto il grafico Sankey Diagram$^{G}$.
    \item \textbf{Postcondizioni:} Il grafico viene mostrato secondo le scelte selezionate dall'utente.
    \item \textbf{Scenario principale}:
    \begin{enumerate}
