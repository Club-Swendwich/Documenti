...
\begin{longtable}{p{0.12\linewidth}p{0.15\linewidth}p{0.50\linewidth}p{0.15\linewidth}}
    ...
    \rowcolor[RGB]{233, 245, 206}
    R1V7 & Obbligatorio & L'applicazione deve supportare il browser Google Chrome (versione $\geq$ 98) & valutazione RTB prof. Cardin \\
    \rowcolor[RGB]{216, 235, 171}
    R1V8 & Obbligatorio & L'applicazione deve supportare il browser Microsoft Edge (versione $\geq$ 98) & valutazione RTB prof. Cardin \\
    \rowcolor[RGB]{233, 245, 206}
    R1V9 & Obbligatorio & L'applicazione deve supportare il browser Mozilla Firefox (versione $\geq$ 96) & valutazione RTB prof. Cardin \\
    \rowcolor[RGB]{216, 235, 171}
    R1V10 & Obbligatorio & L'applicazione deve supportare il browser Safari (versione $\geq$ 15.1) & valutazione RTB prof. Cardin \\
