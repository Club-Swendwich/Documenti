...
Gli strumenti da utilizzare in questo processo sono:
\begin{itemize}
    \item D3.js$^{G}$: libreria JavaScript per la realizzazione del grafico Scatter Plot$^{G}$ nel \textit{Proof of Concept}.\\
    \href{https://d3js.org/}{https://d3js.org/}
    \item React  libreria JavaScript per la realizzazione del \textit{Proof of Concept$^{G}$}.\\
