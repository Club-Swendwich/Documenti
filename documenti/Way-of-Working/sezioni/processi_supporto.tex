...
Per permettere un avanzamento \textit{agile} e tracciare lo stato delle attività è stato deciso di utilizzare una Scrum$^G$  board su Trello.
...
\begin{itemdescript}
    ...
    \item [Backlog] Lista delle card relative a issues$^G$  che sono in attesa di essere assegnate ad uno sprint.
...
\noindent Le issues$^G$  create in questo modo saranno automaticamente trasformate in \textit{Trello cards} e inserite nel Backlog grazie all'integrazione con Zapier. \\
