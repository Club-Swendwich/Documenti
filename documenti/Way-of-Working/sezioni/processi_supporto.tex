...
\setlength\extrarowheight{5pt}
    ...
    \begin{longtable}{cp{0.28\linewidth}p{0.13\linewidth}p{0.31\linewidth}}
    \rowcolor[RGB]{33, 73, 50}
...
\begin{table}[htb]
    \centering
    \begin{tabular}{cp{0.30\linewidth}p{0.17\linewidth}p{0.30\linewidth}}
    \rowcolor[RGB]{33, 73, 50}
...
\subsubsection{Metriche di qualità}
Si utilizzano le seguenti metriche di processo:
