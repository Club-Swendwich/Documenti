...
La struttura delle tabelle relative alla sezione \textit{Requisiti} nel documento \textit{Analisi dei requisiti} sono strutturate nel modo seguente:
\begin{itemize}
    \item   \textbf{Codice identificativo:}
            ...
            \end{enumerate}
            Con \textbf{Tipo} viene indicata la natura nel requisito, le possibilità sono le seguenti:
            \begin{itemize}
    ...
    \item \textbf{Classe:} Serve a rendere più esplicita la tabella viene infatti riportato il peso già espresso nel codice identificativo ma questa volta scritto a parole.
