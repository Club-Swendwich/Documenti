...
\subsection{MobX}
E' una libreria che si occupa della gestione degli stati su framework come react. Facilita la loro gestione e permette di scrivere codice più contenuto ed efficiente.

\subsection{Model-View-Controller}
Model-view-controller, in informatica, è un pattern architetturale molto diffuso nello sviluppo di sistemi software, in particolare nell'ambito della programmazione orientata agli oggetti e in applicazioni web, in grado di separare la logica di presentazione dei dati dalla logica di business.

\subsection{Model-View-Viewmodel}
Il Model–view–viewmodel è un pattern software architetturale o schema di progettazione software. È una variante del pattern "Presentation Model design" di Martin Fowler. Lo MVVM astrae lo stato di "view" e il comportamento
...
La signature indica la firma di una trasformazione, ovvero tutti quei dati che identificano di fatto una trasformazione.
Troviamo infatti "identifier" che è l'identificativo, "from" che indica il tipo di dato che vogliamo trasformare, "to" il tipo di dato in cui vogliamo trasformarlo 
...
\subsection{To Do}
Vengono etichettate con "to do" tutte quelle issue che devono ancora essere iniziate ma segnate nel corrente sprint. 
