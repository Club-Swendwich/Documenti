...
\subsection{Issue}
Una Issue in GitHub è un modo per tenere in ordine e assegnare le varie features da completare a scopo di collaborazione.
...
\section{Z}
\subsection{Zapier}
Zapier è un sistema di automazione in genere utilizzato per gestire le task nella filosofia agile.