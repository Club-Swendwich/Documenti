...
Progetto di minore interesse tra i membri del gruppo \\
\end{tabularx}
\end{table}
...
\\\cmidrule(r{3\tabcolsep}){1-1}\cmidrule(l{-\tabcolsep}){2-2}
% PROS, seperated by empty line or \par
Il gruppo non si è soffermato a valutare il seguente progetto in quanto non ha suscitato interesse nei membri 
&
% CONS, seperated by empty line or \par
...
\\\cmidrule(r{3\tabcolsep}){1-1}\cmidrule(l{-\tabcolsep}){2-2}
% PROS, seperated by empty line or \par
Disponibilità per ore di formazione tecnica
&
% CONS, seperated by empty line or \par
Scarso interesse generale da parte del gruppo \\
\end{tabularx}
